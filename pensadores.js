...
function gregos_reveal() { 
        for (var i = 0; i < box_gregos.length; i++) 
        { box_gregos[i].style.display = 'grid'; } 
        for (var i = 0; i < box_alemaes.length; i++)
        { box_alemaes[i].style.display = 'none'; } 
        for (var i = 0; i < box_franceses.length; i++) 
        { box_franceses[i].style.display = 'none';} 
} 
function alemaes_reveal() { 
        for (var i = 0; i < box_gregos.length; i++) 
        { box_gregos[i].style.display = 'none'; } 
        for (var i = 0; i < box_alemaes.length; i++) 
        { box_alemaes[i].style.display = 'grid'; } 
        for (var i = 0; i < box_franceses.length; i++) 
        { box_franceses[i].style.display = 'none'; } 
}
function franceses_reveal() { 
        for (var i = 0; i < box_gregos.length; i++) 
        { box_gregos[i].style.display = 'none'; } 
        for (var i = 0; i < box_alemaes.length; i++) 
        { box_alemaes[i].style.display = 'none'; } 
        for (var i = 0; i < box_franceses.length; i++) 
        { box_franceses[i].style.display = 'grid'; } 
} 
...
if (inputBusca.value != '') 
{
    for (let card of cards) 
    {
        ...
        let nome = card.querySelector('h3'); nome = nome.textContent.toLowerCase(); 
        ...
        {   
            console.log('O texto inclui ' + nome)
